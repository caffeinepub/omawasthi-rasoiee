...
export class Backend implements backendInterface {
    ...
    async createRecipe(arg0: Recipe): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async filterByCategory(arg0: string): Promise<Array<Recipe>> {
        if (this.processError) {
            try {
    ...
    async initializeSeeds(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeSeeds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Ingredient]): Ingredient | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Recipe]): Recipe | null {
    return value.length === 0 ? null : value[0];
}
